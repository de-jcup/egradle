...
public class EGradleProcessConsolePageParticipant implements IConsolePageParticipant {
    @Override
    ...
    public void init(IPageBookViewPage page, IConsole console) {
        if (page.getControl() instanceof StyledText) {
        	...
        	/* only process consoles with EGradle in name are handled or the dedicated EGradle console*/
        	...
        	needsEGradleStyling = needsEGradleStyling || ("org.eclipse.debug.ui.ProcessConsoleType".equals(type) && name.indexOf("EGradle")!=-1);
            ...
            EGradleProcesssConsoleStyleListener myListener = new EGradleProcesssConsoleStyleListener();
