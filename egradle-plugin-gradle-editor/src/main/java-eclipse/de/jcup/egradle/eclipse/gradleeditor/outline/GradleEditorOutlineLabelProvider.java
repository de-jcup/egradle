...
public class GradleEditorOutlineLabelProvider extends BaseLabelProvider implements IStyledLabelProvider, IColorProvider {
    ...
    public Image getImage(Object element) {
        if (element instanceof Item) {
            ...
            case PLUGINS:
                return getOutlineImage(ICON_PLUGINS);
            case REPOSITORIES:
