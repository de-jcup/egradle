...
public class SimpleBrowserInformationControl extends AbstractInformationControl {
    ...
    /**
     * Creates an simple browser information control being resizable, providing NO
     * toolbar and does NOT support hyper link listening
     * 
     * @param parentShell
     */
    ...
    public void setInformation(String information) {
        ...
        if (isBrowserNotDisposed()) {
            ...
            if (history.isEmpty()) {
                 ...
                 * necessary to add current HTML to history too! All other history entries are
                 * done by link mechanism.
                 */
    ...
    public IInformationControlCreator getInformationPresenterControlCreator() {
        /*
         * Its necessary to implement this - otherwise leaving the origin tooltip area,
         * which does not contain the browser control, will hide the control. It would
         * be nicer if eclipse would have an easier mechanism to reuse the origin
         * control!
         */
