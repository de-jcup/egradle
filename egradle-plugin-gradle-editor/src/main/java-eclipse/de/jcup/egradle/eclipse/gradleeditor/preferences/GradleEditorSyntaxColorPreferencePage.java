    ...
    protected void createFieldEditors() {
        ...
        restoreDarkThemeColorsButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                changeColor(editorMap, COLOR_GRADLE_DEPRECATED_KEYWORD, GradleEditorColorConstants.BRIGHT_WARNINGING_RED);
            ...
            private void changeColor(Map<GradleEditorSyntaxColorPreferenceConstants, ColorFieldEditor> editorMap, GradleEditorSyntaxColorPreferenceConstants colorId, RGB rgb) {
