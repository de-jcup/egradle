...
public class GradleEditorSyntaxColorPreferencePage extends FieldEditorPreferencePage
	...
	protected void createFieldEditors() {
		...
		for (GradleEditorSyntaxColorPreferenceConstants colorIdentifier : GradleEditorSyntaxColorPreferenceConstants
				.values()) {
			ColorFieldEditor editor = new ColorFieldEditor(colorIdentifier.getId(), colorIdentifier.getLabelText(),
					parent);
