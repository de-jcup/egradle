...
public class GradleCompletionProposal implements ICompletionProposal, ICompletionProposalExtension3 /* , ICompletionProposalExtension6 */ {
     ...
     */
    public GradleCompletionProposal(Proposal proposal, int replacementOffset, int replacementLength, Image image, IContextInformation contextInformation, String additionalProposalInfo,
