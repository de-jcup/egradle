...
public class TestUtil {
    ...
    static {
        if (!SRC_TEST_RES_FOLDER.exists()) {
            /*
             * fall back - to be testable by eclipse in sub projects and also via gradle
             * from root project.
             */
    ...
    /**
     * Rootfolder 2 - is a multi project - contains itself a .project, which must be
     * ignored at imports, because we prefer virtual root project...
     */
     ...
     * in text "alpha beta gamma" returns 5 because it is the end position of
     * "alpha"
     * 
     * @param text
     * @param searchString
     * @return index end
     * @throws IllegalArgumentException when text is <code>null</code> or
     *                                  searchstring is <code>null</code> or when
