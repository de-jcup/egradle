...
public class GradleRootProjectTest {
	...
	@Test
	public void rootproject1_has_no_gradle_settings_and_so_identified_as_single_project__as_fallback()
			throws Exception {
		GradleRootProject root1 = new GradleRootProject(CoreTestUtil.ROOTFOLDER_1);
		assertFalse(root1.isMultiProject());
	}

	@Test
	public void rootproject2_is_identified_as_multiproject() throws Exception {
		GradleRootProject root2 = new GradleRootProject(CoreTestUtil.ROOTFOLDER_2);
		assertTrue(root2.isMultiProject());
	}

	@Test
	public void rootproject3_is_identified_as_singleproject() throws Exception {
		GradleRootProject root3 = new GradleRootProject(CoreTestUtil.ROOTFOLDER_3);
		assertFalse(root3.isMultiProject());
	}

	@Test
	public void rootproject4_is_identified_as_singleproject_even_when_having_an_include_comment_inside()
			throws Exception {
		GradleRootProject root4 = new GradleRootProject(CoreTestUtil.ROOTFOLDER_4);
	...
	public void add_subproject_to_gradle_multiproject_creates_subfolder_with_empty_build_gradle() throws Exception {
		/* prepare */
		File rootFolder = CoreTestUtil.createTempTestFolder();
	...
	@Test
	public void add_subproject_to_gradle_multiproject_having_a_core_subproject_adds_new_subproject_to_end_of_file_and_keeps_old_content()
			throws Exception {
		/* prepare */
		File rootFolder = CoreTestUtil.createTempTestFolder();
