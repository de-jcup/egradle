...
public class IdentifierStringIdBuilderTest {
	...
	public void test_document_identifier1_and_2() {
		/* execute */
		String[] created = builderToTest.addAll(DocumentTestidentifiers1.values())
				.addAll(DocumentTestidentifiers2.values()).build();
	...
	public void test_default_and_document_identifier1_and_2() {
		/* execute */
		String[] created = builderToTest.add("default").addAll(DocumentTestidentifiers1.values())
				.addAll(DocumentTestidentifiers2.values()).build();
