...
public class GradleExecutorTest {
    ...
    public void two_gradle_options_are_prefixed_to_command() throws Exception {
        ...
        executorToTest.execute(mockedContext);
        /* test */
        verify(mockedProcessExecutor).execute(mockedConfiguration, mockedContext, mockedContext, "gradleCommand", "-test1", "-test2", "mockedCommand1");
    }
    ...
    public void gradle_properties_are_prefixed_to_command() throws Exception {
        ...
        executorToTest.execute(mockedContext);
        /* test */
        verify(mockedProcessExecutor).execute(mockedConfiguration, mockedContext, mockedContext, "gradleCommand", "-Pgradle.test.property=test", "mockedCommand1");
    }
    ...
    public void system_properties_are_prefixed_to_command() throws Exception {
        ...
        executorToTest.execute(mockedContext);
        /* test */
        verify(mockedProcessExecutor).execute(mockedConfiguration, mockedContext, mockedContext, "gradleCommand", "-Dsystem.test.property=test", "mockedCommand1");
    }
    ...
    public void gradle_properties_and_then_system_properties_are_prefixed_to_command() throws Exception {
        ...
        executorToTest.execute(mockedContext);
        /* test */
        verify(mockedProcessExecutor).execute(mockedConfiguration, mockedContext, mockedContext, "gradleCommand", "-Pgradle.test.property=test", "-Dsystem.test.property=test", "mockedCommand1");
    }
    ...
    public void options_then_gradle_properties_and_then_system_properties_are_prefixed_to_command() throws Exception {
        ...
        executorToTest.execute(mockedContext);
        /* test */
        verify(mockedProcessExecutor).execute(mockedConfiguration, mockedContext, mockedContext, "gradleCommand", "-option", "-Pgradle.test.property=test", "-Dsystem.test.property=test",
                "mockedCommand1");
    }
