...
/**
 * Handles offset calculation by given lines. Handles also CR+LF, CR, LF
 * correctly. See <a href="https://en.wikipedia.org/wiki/Newline">Wikipedia -
 * NewLine</a>
 * 
...
public class OffsetCalculatorTest {
	...
	public void for_text_12345_newline_6__line_1_column_6_returns_6() {
		...
		assertEquals(5, offset); // 6 because \n is a character and has
									// offset... but offset starts at 0 and not
									// on 1 like column
	...
	public void for_text_12345_newline_6__line_1_column_7_returns_UNKNOWN() {
		...
		assertEquals(-1, offset); // -1 because line has only 6 characters:
									// 12345\n
	...
	public void newline_windows_and_unix_mixed__for_text_12345_cr_lf_6__cr_7_line_3_column_1_returns_10() {
		...
		int expectedOffset = sb.length() - 1; // offset is not length, because
												// 0..
