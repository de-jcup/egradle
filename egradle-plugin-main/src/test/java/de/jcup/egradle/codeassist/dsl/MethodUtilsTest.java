...
public class MethodUtilsTest {
	...
	public void isMethodIdentified_method_myMethod_with_param1_String_name_param2_Object_data_param3_int_size() {
		...
		/* execute + test */
		assert100Percent(
				MethodUtils.calculateMethodIdentificationPercentage(method, "myMethod", "String", "Object", "int"));
	}
	...
	public void isMethodIdentified_method_myMethod_with_param1_String_name_param2_Object_data_param3_int_size__NOT_when_arguments_other_ordered() {
		...
		/* execute + test */
		assertPercent(66,
				MethodUtils.calculateMethodIdentificationPercentage(method, "myMethod", "String", "int", "Object"));
		assert50Percent(
				MethodUtils.calculateMethodIdentificationPercentage(method, "myMethod", "Object", "String", "Object"));
	}
	...
	public void isMethodIdentified_method_myMethod_with_param1_String_name_param2_Object_data_param3_int_size__NOT_when_another_argument_given() {
		...
		/* execute + test */
		assert50Percent(MethodUtils.calculateMethodIdentificationPercentage(method, "myMethod", "String", "Object",
				"int", "String"));
	}
