...
public class GradleDSLTypeProviderTest {
	...
	@Test
	public void type_provider_resolves_super_types_and_its_superSuperType_for_type_and_set_instance_into_type()
			throws Exception {
		/* prepare */
		ModifiableType mockedType = mock(ModifiableType.class);
		when(mockedType.getSuperTypeAsString()).thenReturn("superType");
	...
	@Test
	public void type_provider_loads_mappings_by_apimapping_importer_only_one_time_next_type_resolving_for_other_type_does_not_load()
			throws Exception {
		/* prepare */
