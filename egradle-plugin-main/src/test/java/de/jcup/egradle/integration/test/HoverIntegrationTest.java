...
public class HoverIntegrationTest {
    ...
    @Ignore
    /*
     * TODO ATR, 12.03.2017: strange: CheckStyleReports, to which is delegated has a
     * html method but this method is a simple getter without Parameter. So how does
     * the example - visible in javadoc /egradle sdk works (see test-15 file) ?
     */
    ...
    private HoverData calculateHoverData(String text, int offset) {
        ...
        return hoverSupport.caclulateHoverData(text, offset, relevantCodeCutter, buildModel, GradleFileType.GRADLE_BUILD_SCRIPT, estimator);
    }
