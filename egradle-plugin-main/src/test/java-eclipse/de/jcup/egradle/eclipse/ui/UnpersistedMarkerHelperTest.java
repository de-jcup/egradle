...
public class UnpersistedMarkerHelperTest {
	...
	@Test
	public void when_marker_is_registered_but_exists_return_true_and_get_type_throws_exception_the_marker_will_be_still_removed()
			throws Exception {
		/* prepare */
	...
	@Test
	public void when_marker_is_registered_but_exists_return_true_and_get_type_throws_no_exception_the_marker_will_be_removed()
			throws Exception {
		/* prepare */
		IMarker marker = mock(IMarker.class);
		when(marker.exists()).thenReturn(true);
