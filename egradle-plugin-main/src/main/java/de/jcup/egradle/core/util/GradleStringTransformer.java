...
/**
 * Implementation must be able to transform GString text containing gradle
 * variables to normal text.<br>
 * <br>
 * 
 * e.g. <br>
 * root project resides in "/develop/great-project"<br>
 * <code>"${rootproject}/subproject1/build.gradle"</code> will be transformed to
 * <code>"/develop/great-project/subproject1/build.gradle"</code>
 * 
