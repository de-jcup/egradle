...
public class RememberLastLinesOutputHandler implements OutputHandler {
	...
	/**
	 * Creates an output outputHandler which remembers maximum entries max
	 * maximum entry amount to remember. When output exceeds amount of entries
	 * only the newest will remain
	 * 
	 * @param max
	 */
