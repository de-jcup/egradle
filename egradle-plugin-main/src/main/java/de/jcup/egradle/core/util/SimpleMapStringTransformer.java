...
public class SimpleMapStringTransformer implements GradleStringTransformer {
    ...
    /**
     * Builds the transformer - transformer is immutable, changes to map after
     * creation will have no effect to the transformer
     * 
     * @param map
     */
     ...
     * 
     * @param map
     * @param separator - separator to use. if <code>null</code> the default
