...
public class History<T> {
	...
	/**
	 * Returns last entry but does not influence history. Element will stay on
	 * stack
	 * 
	 ...
	 * 
	 * @param content
	 *            value to add, <code>null</code> is ignored
	 */
	...
	/**
	 * Returns last history entry and removes it from history, or when no more
	 * entry available <code>null</code>
	 * 
