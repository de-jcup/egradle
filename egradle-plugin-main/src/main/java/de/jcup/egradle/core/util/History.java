...
public class History<T> {
    ...
    /**
     * Returns last history entry and removes it from history, or when no more entry
     * available <code>null</code>
     * 
    ...
    /**
     * Returns list of current items inside history. The list is ordered from last
     * to first
     * 
