...
public class Item {
    ...
    /**
     * Set name and calculate identifier - if you want to explicit set identifer you
     * must it after calling this method via {@link #setIdentifier(String)}
     * 
     * @param name
     */
    ...
    /**
     * Be aware: {@link #setName(String)} does change identifier too! Calling this
     * method should only be necessary in some special cases!
     * 
     * @param identifier
     */
    ...
    /**
     * Get the identifier of the item, means name without additional parts - e.g.
     * name="task myTask", identifier="task"
     * 
     * @return identifier
     */
    ...
    /**
     * Creates a string containing all information of this item, separated by space,
     * parameters with comma
     * 
     * @param withType - when <code>true</code> the type (if set) is inside search
