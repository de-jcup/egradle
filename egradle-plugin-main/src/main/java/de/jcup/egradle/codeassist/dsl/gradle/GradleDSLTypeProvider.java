...
public class GradleDSLTypeProvider implements TypeProvider, RegistryListener, CodeCompletionService {
    ...
    public Type getType(String name) {
        ...
        /*
         * Put uninitialized type - so avoiding endless loops while collecting. This
         * means: no inherited methods etc. But when doing this and a loop exists, at
         * this time not all information is available and inheritance will not work
         */
        nameToTypeMapping.put(name, type);
