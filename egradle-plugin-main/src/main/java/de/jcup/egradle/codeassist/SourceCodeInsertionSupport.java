...
public class SourceCodeInsertionSupport {
    ...
    /**
     * Transform text before column to indent string. Purpose for this method is to
     * have exact same column as on code completion before. Because text before can
     * also contain parts of the code proposal itself the text before last
     * whitespace will not be used for indention.<br>
     * <br>
     * 
     * An example:
     * 
