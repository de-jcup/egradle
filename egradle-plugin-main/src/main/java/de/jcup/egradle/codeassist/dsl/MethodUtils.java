...
public class MethodUtils {
     ...
     * 
     * @param method - if <code>null</code> - result will be "null"
     ...
     * <li>If a method is has same name, same param size, but x parameters of n are
     * not equal 50%-100% is returned</li>
     ...
     * @return percentage
     */
    public static int calculateMethodIdentificationPercentage(Method method, String itemIdentifier, String... itemParameters) {
        if (method == null) {
            return 0;
        }
    ...
    /**
     * Check if methods have same signature. Having any null values will result in
     * <code>false</code> as result!
     * 
     * @param method1
     * @param method2
     * @return result
