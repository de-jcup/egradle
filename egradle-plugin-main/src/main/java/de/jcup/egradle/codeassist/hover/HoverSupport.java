...
public class HoverSupport {
     ...
     * 
     * @param allText    text for which is hover data calculated. if not
     *                   <code>null</code> or blank, result will always be
     *                   <code>null</code>
     * @param offset     offset inside text ,if out of range, result will always be
     *                   <code>null</code>
     ...
     * @throws IllegalArgumentException if one of the mandatory parameters is
     *                                  missing
     */
