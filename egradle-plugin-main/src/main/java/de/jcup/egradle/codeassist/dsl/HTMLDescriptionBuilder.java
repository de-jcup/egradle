...
public class HTMLDescriptionBuilder {
     ...
     * @param data
     * @param element
     * @param prefix       can be <code>null</code>, otherwise its rendered before
     *                     first body element
    ...
    private String createStyles(String fgColor, String bgColor, String commentColor) {
        ...
        style.append(".fullName{font-weight: bold;font-size:small;white-space: nowrap;font-family:'Courier New', Courier, monospace}\n");
