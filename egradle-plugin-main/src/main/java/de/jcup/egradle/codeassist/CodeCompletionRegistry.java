...
public class CodeCompletionRegistry {
    ...
    /**
     * (Re-)Initialize registry and the code completion parts inside. Will inform
     * all registry listeners about rebuild in correct ordered types
     */
    public void init() {
     ...
     * {@link RegistryListener} if will listen now. If there was a former service
     * installed it will be deinstalled (if being a listener it will also be removed
     * as listener as well). To simply deinstall a listener use new service with
     * <code>null</code>
     * 
     * @param serviceClazz
     * @param service
