...
public interface Type extends LanguageElement, GradleDocumentationInfo, Comparable<Type> {
    ...
    /**
     * Return interfaces as type reference set, never <code>null</code>. Only direct
     * inherited interface types will be returned. Not full hierarchy!
     * 
    ...
    /**
     * Returns reason for element. A reason will contain information about plugin or
     * super type. reason will be null if element is not contained, or element is
     * defined in type itself.
     * 
     * @param element
