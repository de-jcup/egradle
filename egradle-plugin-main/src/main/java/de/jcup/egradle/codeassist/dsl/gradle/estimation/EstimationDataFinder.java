...
class EstimationDataFinder {
     ...
     * visitor will be called and found result will be compared to already existing
     * one and the more suitable will be returned
     * 
     * @param alreadyFound - if percentage is already 100 always this parameter will
     *                     be returned as result. Can be <code>null</code>
     * @param item         - current item from model. If <code>null</code> always
     *                     null is returned
     * @param visitor      - visitor to use
     * @return
     */
    protected EstimationData findMostSuitable(EstimationData alreadyFound, Type current, Item item, EstimationStrategy visitor) {
