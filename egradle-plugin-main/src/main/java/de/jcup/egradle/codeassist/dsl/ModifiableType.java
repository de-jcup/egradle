...
public interface ModifiableType extends Type {
    ...
    /**
     * Inherit methods and properties from super type. If this type is an interface
     * it can only extend interface types, otherwise it can only extend from (one)
     * super type. The method does not throw any error when trying to do a wrong
     * extension but does nothing
     * 
     * @param superType
     */
