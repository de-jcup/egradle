 ...
 *
 * Contributing authors: Jeremy Rayner groovy@ross-rayner.com John Mitchell
 * johnm@non.net Terence Parr parrt@magelang.com John Lilley jlilley@empathy.com
 * Scott Stanchfield thetick@magelang.com Markus Mohnen
 * mohnen@informatik.rwth-aachen.de Peter Williams pete.williams@sun.com Allan
 * Jacobs Allan.Jacobs@eng.sun.com Steve Messick messick@redhills.com John Pybus
 * john@pybus.org
 *
 ...
 * charVocabulay makes code file big, but only in the bitsets at the end. I need
 * to make ANTLR generate unicode bitsets more efficiently. Version 1.19 (April
 * 25, 2002) Terence added in nice fixes by John Pybus concerning floating
 * constants and problems with super() calls. John did a nice reorg of the
 * primary/postfix expression stuff to read better and makes f.g.super() parse
 * properly (it was METHOD_CALL not a SUPER_CTOR_CALL). Also:
 *
 ...
 * "implements" keyword, since thats what JSR14 seems to imply. o Thanks to
 ...
 *
 * Version 1.22.4.j.1 Changes by Jeremy Rayner to support java2groovy tool o I
 * have taken java.g for Java1.5 from Michael Studman (1.22.4) and have made
 * some changes to enable use by java2groovy tool (Jan 2007)
 *
...
public class JavaRecognizer extends antlr.LLkParser implements JavaTokenTypes {
	 ...
	 * same background information as another supplied Token (e.g. line numbers)
	 * to be used in place of antlr tree construction syntax, i.e.
	...
	public final void annotations() throws RecognitionException, TokenStreamException {
		...
		if (inputState.guessing == 0) {
			...
			annotations_AST = (AST) astFactory
					.make((new ASTArray(2)).add(astFactory.create(ANNOTATIONS, "ANNOTATIONS")).add(annotations_AST));
	...
	public final void enumDefinition(AST modifiers) throws RecognitionException, TokenStreamException {
		...
		if (inputState.guessing == 0) {
			...
			enumDefinition_AST = (AST) astFactory.make((new ASTArray(5)).add(create(ENUM_DEF, "ENUM_DEF", first, LT(1)))
					.add(modifiers).add(tmp19_AST).add(ic_AST).add(eb_AST));
	...
	public final void classBlock() throws RecognitionException, TokenStreamException {
		...
		if (inputState.guessing == 0) {
			...
			classBlock_AST = (AST) astFactory
					.make((new ASTArray(2)).add(astFactory.create(OBJBLOCK, "OBJBLOCK")).add(classBlock_AST));
	...
	public final void interfaceBlock() throws RecognitionException, TokenStreamException {
		...
		if (inputState.guessing == 0) {
			...
			interfaceBlock_AST = (AST) astFactory
					.make((new ASTArray(2)).add(astFactory.create(OBJBLOCK, "OBJBLOCK")).add(interfaceBlock_AST));
	...
	public final void enumBlock() throws RecognitionException, TokenStreamException {
		...
		if (inputState.guessing == 0) {
			...
			enumBlock_AST = (AST) astFactory
					.make((new ASTArray(2)).add(astFactory.create(OBJBLOCK, "OBJBLOCK")).add(enumBlock_AST));
	...
	public final void annotationBlock() throws RecognitionException, TokenStreamException {
		...
		if (inputState.guessing == 0) {
			...
			annotationBlock_AST = (AST) astFactory
					.make((new ASTArray(2)).add(astFactory.create(OBJBLOCK, "OBJBLOCK")).add(annotationBlock_AST));
	...
	public final void classField() throws RecognitionException, TokenStreamException {
		...
		if ((_tokenSet_14.member(LA(1))) && (_tokenSet_15.member(LA(2)))) {
				...
				case LITERAL_double: {
					...
					}
					{
						if ((LA(1) == IDENT) && (LA(2) == LPAREN)) {
							...
							if (inputState.guessing == 0) {
								classField_AST = (AST) currentAST.root;
								classField_AST = (AST) astFactory
										.make((new ASTArray(5)).add(create(METHOD_DEF, "METHOD", first, LT(1)))
							...
							t_AST = (AST) returnAST;
							{
								if ((LA(1) == IDENT) && (LA(2) == LPAREN)) {
									...
									if (inputState.guessing == 0) {
										classField_AST = (AST) currentAST.root;
										classField_AST = (AST) astFactory
												.make((new ASTArray(8)).add(create(METHOD_DEF, "METHOD", first, LT(1)))
														.add(mods_AST).add(tp_AST)
														.add((AST) astFactory.make((new ASTArray(2))
																.add(create(TYPE, "TYPE", first, LT(1))).add(rt_AST)))
														.add(tmp92_AST).add(param_AST).add(tc_AST).add(s2_AST));
										currentAST.root = classField_AST;
										currentAST.child = classField_AST != null
												&& classField_AST.getFirstChild() != null
														? classField_AST.getFirstChild() : classField_AST;
										currentAST.advanceChildToEnd();
									}
			...
			if (inputState.guessing == 0) {
				classField_AST = (AST) currentAST.root;
				classField_AST = (AST) astFactory
						.make((new ASTArray(2)).add(create(STATIC_INIT, "STATIC_INIT", first, LT(1))).add(s3_AST));
				currentAST.root = classField_AST;
				currentAST.child = classField_AST != null && classField_AST.getFirstChild() != null
						? classField_AST.getFirstChild() : classField_AST;
				currentAST.advanceChildToEnd();
			...
			if (inputState.guessing == 0) {
				classField_AST = (AST) currentAST.root;
				classField_AST = (AST) astFactory
						.make((new ASTArray(2)).add(create(INSTANCE_INIT, "INSTANCE_INIT", first, LT(1))).add(s4_AST));
				currentAST.root = classField_AST;
				currentAST.child = classField_AST != null && classField_AST.getFirstChild() != null
						? classField_AST.getFirstChild() : classField_AST;
				currentAST.advanceChildToEnd();
			...
			case LITERAL_double: {
				...
				t_AST = (AST) returnAST;
				{
					if ((LA(1) == IDENT) && (LA(2) == LPAREN)) {
						...
						if (inputState.guessing == 0) {
							interfaceField_AST = (AST) currentAST.root;
							interfaceField_AST = (AST) astFactory.make((new ASTArray(7))
									.add(create(METHOD_DEF, "METHOD", first, LT(1))).add(mods_AST).add(tp_AST)
									.add((AST) astFactory.make(
											(new ASTArray(2)).add(create(TYPE, "TYPE", first, LT(1))).add(rt_AST)))
									.add(tmp98_AST).add(param_AST).add(tc_AST));
							currentAST.root = interfaceField_AST;
							currentAST.child = interfaceField_AST != null && interfaceField_AST.getFirstChild() != null
									? interfaceField_AST.getFirstChild() : interfaceField_AST;
							currentAST.advanceChildToEnd();
	...
	public final void enumConstant() throws RecognitionException, TokenStreamException {
		...
		if (inputState.guessing == 0) {
			...
			enumConstant_AST = (AST) astFactory
					.make((new ASTArray(5)).add(astFactory.create(ENUM_CONSTANT_DEF, "ENUM_CONSTANT_DEF")).add(an_AST)
	...
	public final void enumConstantBlock() throws RecognitionException, TokenStreamException {
		...
		if (inputState.guessing == 0) {
			...
			enumConstantBlock_AST = (AST) astFactory
					.make((new ASTArray(2)).add(astFactory.create(OBJBLOCK, "OBJBLOCK")).add(enumConstantBlock_AST));
				...
				case LITERAL_double: {
					...
					t_AST = (AST) returnAST;
					{
						if ((LA(1) == IDENT) && (LA(2) == LPAREN)) {
							...
							if (inputState.guessing == 0) {
								enumConstantField_AST = (AST) currentAST.root;
								enumConstantField_AST = (AST) astFactory.make((new ASTArray(8))
										.add(create(METHOD_DEF, "METHOD", first, LT(1))).add(mods_AST).add(tp_AST)
										.add((AST) astFactory.make(
												(new ASTArray(2)).add(create(TYPE, "TYPE", first, LT(1))).add(rt_AST)))
										.add(tmp114_AST).add(param_AST).add(tc_AST).add(s2_AST));
								currentAST.root = enumConstantField_AST;
								currentAST.child = enumConstantField_AST != null
	...
	public final void variableDeclarator(AST mods, AST t) throws RecognitionException, TokenStreamException {
		...
		if (inputState.guessing == 0) {
			...
			variableDeclarator_AST = (AST) astFactory.make((new ASTArray(5))
					...
					.add((AST) astFactory.make((new ASTArray(2)).add(create(TYPE, "TYPE", first, LT(1))).add(d_AST)))
	...
	public final void expression() throws RecognitionException, TokenStreamException {
		...
		if (inputState.guessing == 0) {
			...
			expression_AST = (AST) astFactory
					.make((new ASTArray(2)).add(create(EXPR, "EXPR", first, LT(1))).add(expression_AST));
	...
	public final void parameterDeclaration() throws RecognitionException, TokenStreamException {
		...
		if (inputState.guessing == 0) {
			...
			parameterDeclaration_AST = (AST) astFactory.make((new ASTArray(4))
					.add(create(PARAMETER_DEF, "PARAMETER_DEF", first, LT(1))).add(pm_AST)
					.add((AST) astFactory.make((new ASTArray(2)).add(create(TYPE, "TYPE", first, LT(1))).add(pd_AST)))
					.add(id_AST));
	...
	public final void variableLengthParameterDeclaration() throws RecognitionException, TokenStreamException {
		...
		if (inputState.guessing == 0) {
			...
			variableLengthParameterDeclaration_AST = (AST) astFactory.make((new ASTArray(4))
			...
			currentAST.child = variableLengthParameterDeclaration_AST != null
					&& variableLengthParameterDeclaration_AST.getFirstChild() != null
							? variableLengthParameterDeclaration_AST.getFirstChild()
							: variableLengthParameterDeclaration_AST;
			currentAST.advanceChildToEnd();
		}
	...
	public final void parameterModifier() throws RecognitionException, TokenStreamException {
		...
		if (inputState.guessing == 0) {
			...
			parameterModifier_AST = (AST) astFactory.make(
					(new ASTArray(2)).add(create(MODIFIERS, "MODIFIERS", first, LT(1))).add(parameterModifier_AST));
	...
	public final void casesGroup() throws RecognitionException, TokenStreamException {
		...
		if (inputState.guessing == 0) {
			...
			casesGroup_AST = (AST) astFactory
					.make((new ASTArray(2)).add(astFactory.create(CASE_GROUP, "CASE_GROUP")).add(casesGroup_AST));
	...
	public final void forInit() throws RecognitionException, TokenStreamException {
		...
		if (inputState.guessing == 0) {
			...
			currentAST.child = forInit_AST != null && forInit_AST.getFirstChild() != null ? forInit_AST.getFirstChild()
					: forInit_AST;
			currentAST.advanceChildToEnd();
		}
		forInit_AST = (AST) currentAST.root;
	...
	public final void forEachClause() throws RecognitionException, TokenStreamException {
		...
		if (inputState.guessing == 0) {
			...
			forEachClause_AST = (AST) astFactory.make((new ASTArray(2))
					.add(create(FOR_EACH_CLAUSE, "FOR_EACH_CLAUSE", first, LT(1))).add(forEachClause_AST));
	...
	public final void expressionList() throws RecognitionException, TokenStreamException {
		...
		if (inputState.guessing == 0) {
			...
			expressionList_AST = (AST) astFactory
					.make((new ASTArray(2)).add(create(ELIST, "ELIST", first, LT(1))).add(expressionList_AST));
	...
	public final void unaryExpression() throws RecognitionException, TokenStreamException {
		...
		case MINUS: {
			...
			match(MINUS);
			if (inputState.guessing == 0) {
				tmp225_AST.setType(UNARY_MINUS);
			}
			unaryExpression();
			astFactory.addASTChild(currentAST, returnAST);
			unaryExpression_AST = (AST) currentAST.root;
	...
	/**
	 * Match a, a.b.c refs, a.b.c(...) refs, a.b.c[], a.b.c[].class, and
	 * a.b.c.class refs. Also this(...) and super(...). Match this or super.
	 */
	...
	public static final String[] _tokenNames = { "<0>", "EOF", "<2>", "NULL_TREE_LOOKAHEAD", "BLOCK", "MODIFIERS",
			...
			"INTERFACE_DEF", "PACKAGE_DEF", "ARRAY_DECLARATOR", "EXTENDS_CLAUSE", "IMPLEMENTS_CLAUSE", "PARAMETERS",
			"PARAMETER_DEF", "LABELED_STAT", "TYPECAST", "INDEX_OP", "POST_INC", "POST_DEC", "METHOD_CALL", "EXPR",
			"ARRAY_INIT", "IMPORT", "UNARY_MINUS", "UNARY_PLUS", "CASE_GROUP", "ELIST", "FOR_INIT", "FOR_CONDITION",
			"FOR_ITERATOR", "EMPTY_STAT", "\"final\"", "\"abstract\"", "\"strictfp\"", "SUPER_CTOR_CALL", "CTOR_CALL",
			"VARIABLE_PARAMETER_DEF", "STATIC_IMPORT", "ENUM_DEF", "ENUM_CONSTANT_DEF", "FOR_EACH_CLAUSE",
			...
			"WILDCARD_TYPE", "TYPE_UPPER_BOUNDS", "TYPE_LOWER_BOUNDS", "\"package\"", "SEMI", "\"import\"",
			"\"static\"", "LBRACK", "RBRACK", "IDENT", "DOT", "QUESTION", "\"extends\"", "\"super\"", "LT", "GT",
			"COMMA", "SR", "BSR", "\"void\"", "\"boolean\"", "\"byte\"", "\"char\"", "\"short\"", "\"int\"",
			"\"float\"", "\"long\"", "\"double\"", "STAR", "\"private\"", "\"public\"", "\"protected\"",
			"\"transient\"", "\"native\"", "\"threadsafe\"", "\"synchronized\"", "\"volatile\"", "AT", "LPAREN",
			"RPAREN", "ASSIGN", "LCURLY", "RCURLY", "\"class\"", "\"interface\"", "\"enum\"", "BAND", "\"default\"",
			"\"implements\"", "\"this\"", "\"throws\"", "TRIPLE_DOT", "COLON", "\"if\"", "\"else\"", "\"while\"",
			"\"do\"", "\"break\"", "\"continue\"", "\"return\"", "\"switch\"", "\"throw\"", "\"assert\"", "\"for\"",
			"\"case\"", "\"try\"", "\"finally\"", "\"catch\"", "BOR", "PLUS_ASSIGN", "MINUS_ASSIGN", "STAR_ASSIGN",
			"DIV_ASSIGN", "MOD_ASSIGN", "SR_ASSIGN", "BSR_ASSIGN", "SL_ASSIGN", "BAND_ASSIGN", "BXOR_ASSIGN",
			"BOR_ASSIGN", "LOR", "LAND", "BXOR", "NOT_EQUAL", "EQUAL", "LE", "GE", "\"instanceof\"", "SL", "PLUS",
			"MINUS", "DIV", "MOD", "INC", "DEC", "BNOT", "LNOT", "\"true\"", "\"false\"", "\"null\"", "\"new\"",
			"NUM_INT", "CHAR_LITERAL", "STRING_LITERAL", "NUM_FLOAT", "NUM_LONG", "NUM_DOUBLE", "WS", "SL_COMMENT",
	...
	private static final long[] mk_tokenSet_10() {
		long[] data = { 0L, 4611695997792287674L, 137438952448L, 0L, 0L, 0L };
		return data;
	}
	...
	private static final long[] mk_tokenSet_18() {
		long[] data = { 4611686018427387904L, 17179870210L, 0L, 0L };
		return data;
	}
	...
	private static final long[] mk_tokenSet_26() {
		long[] data = { 4611687942572736512L, -3747335747166798917L, 137438953471L, 0L, 0L, 0L };
		return data;
	}
	...
	private static final long[] mk_tokenSet_28() {
		long[] data = { 4611687942572736512L, -57183194580037L, 137438953471L, 0L, 0L, 0L };
		return data;
	}
	...
	private static final long[] mk_tokenSet_32() {
		long[] data = { 4611686018427387904L, -4611676101339513926L, 137438953471L, 0L, 0L, 0L };
		return data;
	}
	...
	private static final long[] mk_tokenSet_40() {
		long[] data = { 0L, 768L, 98304L, 0L, 0L, 0L };
		return data;
	}
