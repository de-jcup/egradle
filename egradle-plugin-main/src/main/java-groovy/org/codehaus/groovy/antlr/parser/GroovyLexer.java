...
public class GroovyLexer extends antlr.CharScanner implements GroovyTokenTypes, TokenStream {
     ...
     * Return true for keywords, identifiers, and literals. Return true for tokens
     * which can end expressions (right brackets, ++, --). Return false for EOF and
     * all other operator and punctuation tokens. Used to suppress the recognition
     * of /foo/ as opposed to the simple division operator '/'.
     */
    ...
    protected void newlineCheck(boolean check) throws RecognitionException {
        if (check && suppressNewline > 0) {
            require(suppressNewline == 0, "end of line reached within a simple string 'x' or \"x\" or /x/", "for multi-line literals, use triple quotes '''x''' or \"\"\"x\"\"\" or /x/ or $/x/$");
    ...
    protected final void mESC(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        if ((LA(1) == '\\') && (LA(2) == '"' || LA(2) == '$' || LA(2) == '\'' || LA(2) == '0' || LA(2) == '1' || LA(2) == '2' || LA(2) == '3' || LA(2) == '4' || LA(2) == '5' || LA(2) == '6'
                || LA(2) == '7' || LA(2) == '\\' || LA(2) == 'b' || LA(2) == 'f' || LA(2) == 'n' || LA(2) == 'r' || LA(2) == 't' || LA(2) == 'u')) {
            _saveIndex = text.length();
            match('\\');
            text.setLength(_saveIndex);
            {
        ...
        }
        {
            ...
            case '$': {
                ...
                if (inputState.guessing == 0) {
                    ...
                    require(dollarOK, "illegal string body character after dollar sign", "either escape a literal dollar sign \"\\$5\" or bracket the value expression \"${5}\"");
    ...
    public final void mIDENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        if (inputState.guessing == 0) {
            ...
            // Java packages
            if ((ttype == LITERAL_as || ttype == LITERAL_def || ttype == LITERAL_in || ttype == LITERAL_trait) && (LA(1) == '.' || lastSigTokenType == DOT || lastSigTokenType == LITERAL_package)) {
                ttype = IDENT;
            }
            // allow access to classes with the name package
            if ((ttype == LITERAL_package) && (LA(1) == '.' || lastSigTokenType == DOT || lastSigTokenType == LITERAL_import || (LA(1) == ')' && lastSigTokenType == LPAREN))) {
                ttype = IDENT;
            }
    ...
    protected final void mDIGITS_WITH_UNDERSCORE_OPT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        {
            _loop767: do {
                if (((LA(1) >= '0' && LA(1) <= '9')) && (LA(2) == '0' || LA(2) == '1' || LA(2) == '2' || LA(2) == '3' || LA(2) == '4' || LA(2) == '5' || LA(2) == '6' || LA(2) == '7' || LA(2) == '8'
                        || LA(2) == '9' || LA(2) == '_')) {
                    mDIGIT(false);
                } else if ((LA(1) == '_')) {
                    match('_');
    ...
    public final void mNUM_INT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
...

        {
                                ...
                                if ((LA(1) == '0' || LA(1) == '1' || LA(1) == '2' || LA(1) == '3' || LA(1) == '4' || LA(1) == '5' || LA(1) == '6' || LA(1) == '7' || LA(1) == '_')) {
                                    {
                                        _loop787: do {
                                            if (((LA(1) >= '0' && LA(1) <= '7'))
                                                    && (LA(2) == '0' || LA(2) == '1' || LA(2) == '2' || LA(2) == '3' || LA(2) == '4' || LA(2) == '5' || LA(2) == '6' || LA(2) == '7' || LA(2) == '_')) {
                                                matchRange('0', '7');
                                            } else if ((LA(1) == '_')) {
                                                match('_');
                                            } else {
            ...
            case '9': {
                ...
                {
                    if ((LA(1) == '0' || LA(1) == '1' || LA(1) == '2' || LA(1) == '3' || LA(1) == '4' || LA(1) == '5' || LA(1) == '6' || LA(1) == '7' || LA(1) == '8' || LA(1) == '9'
                            || LA(1) == '_')) {
                        mDIGITS_WITH_UNDERSCORE_OPT(false);
                    } else {
                    }
