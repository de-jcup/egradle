...
public interface GroovyTokenTypes {
	...
	int ML_COMMENT = 210;
	int STRING_CH = 211;
	int REGEXP_LITERAL = 212;
	int DOLLAR_REGEXP_LITERAL = 213;
	int REGEXP_CTOR_END = 214;
	int DOLLAR_REGEXP_CTOR_END = 215;
	int ESCAPED_SLASH = 216;
	int ESCAPED_DOLLAR = 217;
	int REGEXP_SYMBOL = 218;
	int DOLLAR_REGEXP_SYMBOL = 219;
	int ESC = 220;
	int STRING_NL = 221;
	int HEX_DIGIT = 222;
	int VOCAB = 223;
	int LETTER = 224;
	int DIGIT = 225;
	int DIGITS_WITH_UNDERSCORE = 226;
	int DIGITS_WITH_UNDERSCORE_OPT = 227;
	int EXPONENT = 228;
	int FLOAT_SUFFIX = 229;
	int BIG_SUFFIX = 230;
}
