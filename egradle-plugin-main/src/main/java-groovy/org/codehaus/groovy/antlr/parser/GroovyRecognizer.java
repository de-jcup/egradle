...
public class GroovyRecognizer extends antlr.LLkParser implements GroovyTokenTypes {
    ...
    /**
     * Create an AST node with the token type and text passed in, but with the same
     * background information as another supplied Token (e.g.&nbsp;line numbers). To
     * be used in place of antlr tree construction syntax, i.e. #[TOKEN,"text"]
     * becomes create(TOKEN,"text",anotherToken)
     *
    ...
    /**
     * Counts the number of LT seen in the typeArguments production. It is used in
     * semantic predicates to ensure we have seen enough closing '>' characters;
     * which actually may have been either GT, SR or BSR tokens.
     */
    private int ltCounter = 0;

    /*
     * This symbol is used to work around a known ANTLR limitation. In a loop with
     * syntactic predicate, ANTLR needs help knowing that the loop exit is a second
     * alternative. Example usage: ( (LCURLY)=> block | {ANTLR_LOOP_EXIT}? )*
    ...
    /**
     * A statement is an type of a block. Typical statements are declarations (which
     * are scoped to the block) and expressions.
     */
    ...
    public final void classDefinition(AST modifiers) throws RecognitionException, TokenStreamException {
        ...
        if (inputState.guessing == 0) {
            ...
            classDefinition_AST = (AST) astFactory
                    .make((new ASTArray(7)).add(create(CLASS_DEF, "CLASS_DEF", first, LT(1))).add(modifiers).add(tmp29_AST).add(tp_AST).add(sc_AST).add(ic_AST).add(cb_AST));
    ...
    public final void traitDefinition(AST modifiers) throws RecognitionException, TokenStreamException {
        ...
        if (inputState.guessing == 0) {
            ...
            traitDefinition_AST = (AST) astFactory
                    .make((new ASTArray(7)).add(create(TRAIT_DEF, "TRAIT_DEF", first, LT(1))).add(modifiers).add(tmp31_AST).add(tp_AST).add(sc_AST).add(ic_AST).add(cb_AST));
    ...
    public final void interfaceDefinition(AST modifiers) throws RecognitionException, TokenStreamException {
        ...
        if (inputState.guessing == 0) {
            ...
            interfaceDefinition_AST = (AST) astFactory
                    .make((new ASTArray(6)).add(create(INTERFACE_DEF, "INTERFACE_DEF", first, LT(1))).add(modifiers).add(tmp33_AST).add(tp_AST).add(ie_AST).add(ib_AST));
    ...
    public final void enumDefinition(AST modifiers) throws RecognitionException, TokenStreamException {
        ...
        if (inputState.guessing == 0) {
            ...
            enumDefinition_AST = (AST) astFactory.make((new ASTArray(5)).add(create(ENUM_DEF, "ENUM_DEF", first, LT(1))).add(modifiers).add(tmp35_AST).add(ic_AST).add(eb_AST));
    ...
    public final void annotationDefinition(AST modifiers) throws RecognitionException, TokenStreamException {
        ...
        if (inputState.guessing == 0) {
            ...
            annotationDefinition_AST = (AST) astFactory.make((new ASTArray(4)).add(create(ANNOTATION_DEF, "ANNOTATION_DEF", first, LT(1))).add(modifiers).add(tmp38_AST).add(ab_AST));
    ...
    /**
     * A declaration is the creation of a reference or primitive-type variable, or
     * (if arguments are present) of a method. Generically, this is called a
     * 'variable' definition, even in the case of a class field or method. It may
     * start with the modifiers and/or a declaration keyword "def". It may also
     * start with the modifiers and a capitalized type name.
     * <p>
    ...
    /**
     * The tail of a declaration. Either v1, v2, ... (with possible initializers) or
     * else m(args){body}. The two arguments are the modifier list (if any) and the
     * declaration head (if any). The declaration head is the variable type, or (for
     * a method) the return type. If it is missing, then the variable type is taken
     * from its initializer (if there is one). Otherwise, the variable type defaults
     * to 'any'. DECIDE: Method return types default to the type of the method body,
     * as an expression.
     */
    public final void variableDefinitions(AST mods, AST t) throws RecognitionException, TokenStreamException {
        ...
        if ((LA(1) == IDENT) && (_tokenSet_27.member(LA(2)))) {
            ...
            if (inputState.guessing == 0) {
                ...
                if (qid_AST != null)
                    id_AST = qid_AST;
                variableDefinitions_AST = (AST) astFactory.make((new ASTArray(7)).add(create(METHOD_DEF, "METHOD", first, LT(1))).add(mods)
                        .add((AST) astFactory.make((new ASTArray(2)).add(create(TYPE, "TYPE", first, LT(1))).add(t))).add(id_AST).add(param_AST).add(tc_AST).add(mb_AST));
    ...
    public final void typeParameters() throws RecognitionException, TokenStreamException {
        ...
        if (!(matchGenericTypeBrackets(((currentLtLevel != 0) || ltCounter == currentLtLevel), "Missing closing bracket '>' for generics types", "Please specify the missing bracket!")))
     ...
     * parameterDeclaration. Used to parse loops like <code>for (int x in y)</code>
     * (up to the <code>in</code> keyword).
     */
    public final void singleDeclarationNoInit() throws RecognitionException, TokenStreamException {
        ...
        case LITERAL_volatile: {
            ...
            if (inputState.guessing == 0) {
                ...
                currentAST.child = singleDeclarationNoInit_AST != null && singleDeclarationNoInit_AST.getFirstChild() != null ? singleDeclarationNoInit_AST.getFirstChild()
    ...
    /**
     * Used in cases where a declaration cannot have commas, or ends with the "in"
     * operator instead of '='.
     */
    public final void singleVariable(AST mods, AST t) throws RecognitionException, TokenStreamException {
        ...
        if (inputState.guessing == 0) {
            ...
            singleVariable_AST = (AST) astFactory.make((new ASTArray(4)).add(create(VARIABLE_DEF, "VARIABLE_DEF", first, LT(1))).add(mods)
                    .add((AST) astFactory.make((new ASTArray(2)).add(create(TYPE, "TYPE", first, LT(1))).add(t))).add(id_AST));
     ...
     * parameterDeclaration. Used to parse declarations used for both binding and
     * effect, in places like argument lists and <code>while</code> statements.
     */
     ...
     * annotation or a modifier token like "final". It may also be introduced by a
     * simple identifier whose first character is an uppercase letter, as in {String
     * x}. A declaration can also be introduced with a built in type like 'int' or
     * 'void'. Brackets (array and generic) are allowed, as in {List[] x} or
     * {int[][] y}. Anything else is parsed as a statement of some sort (expression
     * or command).
     * <p>
     * (In the absence of explicit method-call parens, we assume a capitalized name
     * is a type name. Yes, this is a little hacky. Alternatives are to complicate
     * the declaration or command syntaxes, or to have the parser query the symbol
     * table. Parse-time queries are evil. And we want both {String x} and {println
     * x}. So we need a syntactic razor-edge to slip between 'println' and
     * 'String'.)
     */
     ...
     * In the case of a simple statement {UpperID name} the identifier is taken to
     * be a type name, not a command name.
     */
     ...
     * method. Example: static <T> T foo(){} <T> must be first after the modifier.
     * This rule allows more and does no exact match, but it is only a lookahead,
     * not the real rule.
     */
    ...
    /**
     * After some type names, where zero or more empty bracket pairs are allowed. We
     * use ARRAY_DECLARATOR to represent this.
     */
    ...
    public final void annotationMemberValuePair() throws RecognitionException, TokenStreamException {
        ...
        if (inputState.guessing == 0) {
            ...
            currentAST.child = annotationMemberValuePair_AST != null && annotationMemberValuePair_AST.getFirstChild() != null ? annotationMemberValuePair_AST.getFirstChild()
            ...
            case LITERAL_double: {
                ...
                t_AST = (AST) returnAST;
                {
                    ...
                    if (synPredMatched161) {
                        ...
                        if (inputState.guessing == 0) {
                            annotationField_AST = (AST) currentAST.root;
                            annotationField_AST = (AST) astFactory.make((new ASTArray(5)).add(create(ANNOTATION_FIELD_DEF, "ANNOTATION_FIELD_DEF", first, LT(1))).add(mods_AST)
                                    .add((AST) astFactory.make((new ASTArray(2)).add(create(TYPE, "TYPE", first, LT(1))).add(t_AST))).add(i_AST).add(amvi_AST));
                            currentAST.root = annotationField_AST;
                            currentAST.child = annotationField_AST != null && annotationField_AST.getFirstChild() != null ? annotationField_AST.getFirstChild() : annotationField_AST;
                            currentAST.advanceChildToEnd();
                        }
    ...
    protected final void enumConstantFieldInternal(AST mods, AST tp, AST t, Token first) throws RecognitionException, TokenStreamException {
        ...
        if (synPredMatched182) {
            ...
            if (inputState.guessing == 0) {
                ...
                enumConstantFieldInternal_AST = (AST) astFactory.make((new ASTArray(7)).add(create(METHOD_DEF, "METHOD", first, LT(1))).add(mods)
                        .add((AST) astFactory.make((new ASTArray(2)).add(create(TYPE, "TYPE", first, LT(1))).add(t))).add(tmp178_AST).add(param_AST).add(tc_AST).add(s2_AST));
                if (tp != null) {
                ...
                currentAST.child = enumConstantFieldInternal_AST != null && enumConstantFieldInternal_AST.getFirstChild() != null ? enumConstantFieldInternal_AST.getFirstChild()
                        : enumConstantFieldInternal_AST;
                currentAST.advanceChildToEnd();
            }
        } else if ((LA(1) == IDENT || LA(1) == STRING_LITERAL) && (_tokenSet_61.member(LA(2)))) {
    ...
    /**
     * A list of zero or more formal parameters. If a parameter is variable length
     * (e.g. String... myArg) it should be to the right of any other parameters of
     * the same kind. General form: (req, ..., opt, ..., [rest], key, ...,
     * [restKeys], [block] This must be sorted out after parsing, since the various
     * declaration forms are impossible to tell apart without backtracking.
     */
    public final void parameterDeclarationList() throws RecognitionException, TokenStreamException {
        ...
        if (inputState.guessing == 0) {
            ...
            currentAST.child = parameterDeclarationList_AST != null && parameterDeclarationList_AST.getFirstChild() != null ? parameterDeclarationList_AST.getFirstChild()
    ...
    /**
     * I've split out constructors separately; we could maybe integrate back into
     * variableDefinitions later on if we maybe simplified 'def' to be a type
     * declaration?
     */
    ...
    public final void multipleAssignmentDeclaration() throws RecognitionException, TokenStreamException {
        ...
        if (inputState.guessing == 0) {
            ...
            multipleAssignmentDeclaration_AST = (AST) astFactory.make((new ASTArray(4)).add(create(VARIABLE_DEF, "VARIABLE_DEF", first, LT(1))).add(mods_AST)
                    .add((AST) astFactory.make((new ASTArray(2)).add(create(TYPE, "TYPE", first, LT(1))).add(t_AST))).add(multipleAssignmentDeclaration_AST));
            currentAST.root = multipleAssignmentDeclaration_AST;
            currentAST.child = multipleAssignmentDeclaration_AST != null && multipleAssignmentDeclaration_AST.getFirstChild() != null ? multipleAssignmentDeclaration_AST.getFirstChild()
                    : multipleAssignmentDeclaration_AST;
            currentAST.advanceChildToEnd();
        }
        multipleAssignmentDeclaration_AST = (AST) currentAST.root;
    ...
    /**
     * Declaration of a variable. This can be a class/instance variable, or a local
     * variable in a method It can also include possible initialization.
     */
    public final void variableDeclarator(AST mods, AST t, Token first) throws RecognitionException, TokenStreamException {
        ...
        if (inputState.guessing == 0) {
            ...
            variableDeclarator_AST = (AST) astFactory.make((new ASTArray(5)).add(create(VARIABLE_DEF, "VARIABLE_DEF", first, LT(1))).add(mods)
                    .add((AST) astFactory.make((new ASTArray(2)).add(create(TYPE, "TYPE", first, LT(1))).add(t))).add(id_AST).add(v_AST));
    ...
    /**
     * Zero or more insignificant newlines, all gobbled up and thrown away, but a
     * warning message is left for the user, if there was a newline.
     */
    ...
    public final void expressionStatementNoCheck() throws RecognitionException, TokenStreamException {
        ...
        {
            if (((_tokenSet_76.member(LA(1))) && (_tokenSet_53.member(LA(2)))) && (LA(1) != LITERAL_else && isPathExpr /* && #head.getType()==METHOD_CALL */)) {
                ...
                if (inputState.guessing == 0) {
                    ...
                    currentAST.child = expressionStatementNoCheck_AST != null && expressionStatementNoCheck_AST.getFirstChild() != null ? expressionStatementNoCheck_AST.getFirstChild()
                            : expressionStatementNoCheck_AST;
                    currentAST.advanceChildToEnd();
                }
    ...
    public final void parameterDeclaration() throws RecognitionException, TokenStreamException {
        ...
        if (inputState.guessing == 0) {
            ...
            if (spreadParam) {
                parameterDeclaration_AST = (AST) astFactory.make((new ASTArray(5)).add(create(VARIABLE_PARAMETER_DEF, "VARIABLE_PARAMETER_DEF", first, LT(1))).add(pm_AST)
                        .add((AST) astFactory.make((new ASTArray(2)).add(create(TYPE, "TYPE", first, LT(1))).add(t_AST))).add(id_AST).add(exp_AST));
            } else {
                parameterDeclaration_AST = (AST) astFactory.make((new ASTArray(5)).add(create(PARAMETER_DEF, "PARAMETER_DEF", first, LT(1))).add(pm_AST)
                        .add((AST) astFactory.make((new ASTArray(2)).add(create(TYPE, "TYPE", first, LT(1))).add(t_AST))).add(id_AST).add(exp_AST));
            }
    ...
    /**
     * Closure parameters are exactly like method parameters, except that they are
     * not enclosed in parentheses, but rather are prepended to the front of a
     * block, just after the brace. They are separated from the closure body by a
     * CLOSABLE_BLOCK_OP token '->'.
     */
    ...
    /**
     * A block known to be a closure, but which omits its arguments, is given this
     * placeholder. A subsequent pass is responsible for deciding if there is an
     * implicit 'it' parameter, or if the parameter list should be empty.
     */
    ...
    public final void closableBlockParam() throws RecognitionException, TokenStreamException {
        ...
        if (inputState.guessing == 0) {
            ...
            closableBlockParam_AST = (AST) astFactory
                    .make((new ASTArray(4)).add(create(PARAMETER_DEF, "PARAMETER_DEF", first, LT(1))).add((AST) astFactory.make((new ASTArray(1)).add(create(MODIFIERS, "MODIFIERS", first, LT(1)))))
     ...
     * A block inside an expression or after a method call is always assumed to be a
     * closure. Only labeled, unparameterized blocks which occur directly as
     * substatements are kept open.
     */
    ...
    /**
     * A sub-block of a block can be either open or closable. It is closable if and
     * only if there are explicit closure arguments. Compare this to a block which
     * is appended to a method call, which is given closure arguments, even if they
     * are not explicit in the code.
     */
    ...
    public final void assignmentLessExpression() throws RecognitionException, TokenStreamException {
        ...
        if (inputState.guessing == 0) {
            ...
            currentAST.child = assignmentLessExpression_AST != null && assignmentLessExpression_AST.getFirstChild() != null ? assignmentLessExpression_AST.getFirstChild()
     ...
     * statements as their bodies. Support this practice, even though it isn't very
     * Groovy.
     */
        ...
        if (synPredMatched337) {
            ...
            if (synPredMatched340) {
                ...
                if (inputState.guessing == 0) {
                    ...
                    currentAST.child = compatibleBodyStatement_AST != null && compatibleBodyStatement_AST.getFirstChild() != null ? compatibleBodyStatement_AST.getFirstChild()
                            : compatibleBodyStatement_AST;
                    currentAST.advanceChildToEnd();
                }
                compatibleBodyStatement_AST = (AST) currentAST.root;
            } else if ((_tokenSet_18.member(LA(1))) && (_tokenSet_1.member(LA(2)))) {
     ...
     * parenthesized expression context. Example: println (x || (return)); println
     * assert x, "won't print a false value!" If an optional expression is missing,
     * its value is void (this coerces to null when a value is required).
     */
        ...
        }
        {
            ...
            case COLON: {
                if (inputState.guessing == 0) {
                    ...
                    require(decl_AST != null, "Java-style for-each statement requires a type declaration.", "Use the 'in' keyword, as for (x in y) {...}");
    ...
    /**
     * If two statements are separated by newline (not SEMI), the second had better
     * not look like the latter half of an expression. If it does, issue a warning.
     * <p>
     * Also, if the expression starts with a closure, it needs to have an explicit
     * parameter list, in order to avoid the appearance of a compound statement.
     * This is a hard error.
     * <p>
     * These rules are different from Java's "dumb expression" restriction. Unlike
     * Java, Groovy blocks can end with arbitrary (even dumb) expressions, as a
     * consequence of optional 'return' and 'continue' tokens.
     * <p>
    ...
    public final void checkSuspiciousExpressionStatement(int prevToken) throws RecognitionException, TokenStreamException {
        ...
        if (synPredMatched356) {
            ...
            if (inputState.guessing == 0) {
                require(false, "Ambiguous expression could be a parameterless closure expression, " + "an isolated open code block, or it may continue a previous statement",
                        "Add an explicit parameter list, e.g. {it -> ...}, or force it to be treated " + "as an open block by giving it a label, e.g. L:{...}, "
            ...
            if (inputState.guessing == 0) {
                require(false, "Ambiguous expression could be either a parameterless closure expression or " + "an isolated open code block",
                        "Add an explicit closure parameter list, e.g. {it -> ...}, or force it to " + "be treated as an open block by giving it a label, e.g. L:{...}");
    ...
    /**
     * A member name (x.y) or type name (x[y]) can serve as a command name, which
     * may be followed by a list of arguments. Unlike parenthesized arguments, these
     * must be plain expressions, without labels or spread operators.
     */
    ...
    /**
     * A label for an argument is of the form a:b, 'a':b, "a":b, (a):b, etc.. The
     * labels in (a:b), ('a':b), and ("a":b) are in all ways equivalent, except that
     * the quotes allow more spellings. Equivalent dynamically computed labels are
     * (('a'):b) and ("${'a'}":b) but not ((a):b) or "$a":b, since the latter cases
     * evaluate (a) as a normal identifier. Bottom line: If you want a truly
     * variable label, use parens and say ((a):b).
     */
    ...
    /**
     * An appended block follows any expression. If the expression is not a method
     * call, it is given an empty argument list.
     */
     ...
     * forms of dot, and/or followed by various kinds of brackets. It can be used
     * for value or assigned to, or else further qualified, indexed, or called. It
     * is called a "path" because it looks like a linear path through a data
     * structure. Examples: x.y, x?.y, x*.y, x.@y; x[], x[y], x[y,z]; x(), x(y),
     * x(y,z); x{s}; a.b[n].c(x).d{s} (Compare to a C lvalue, or LeftHandSide in the
     * JLS section 15.26.) General expressions are built up from path expressions,
     ...
     * Note: <code>typeArguments</code> is handled by the caller of
     * <code>namePart</code>.
     */
     ...
     * either is (...) or {...} present, it is a method call. The {...} is appended
     * to the argument list, and matches a formal of type Closure. If there is no
     * method member, a property (or field) is used instead, and must itself be
     * callable.
     * <p>
     * If the methodCallArgs are absent, it is a property reference. If there is no
     * property, it is treated as a field reference, but never a method reference.
     * <p>
     * Arguments in the (...) can be labeled, and the appended block can be labeled
     * also. If there is a mix of unlabeled and labeled arguments, all the labeled
     * arguments must follow the unlabeled arguments, except that the closure
     * (labeled or not) is always a separate final argument. Labeled arguments are
     * collected up and passed as a single argument to a formal of type Map.
     * <p>
     ...
     * contain a general argument list, which is passed to the array type operator,
     * which can make of it what it wants. The brackets may also be empty, as in
     * T[]. This is how Groovy names array types.
     * <p>
    ...
    /**
     * If a dot is followed by a parenthesized or quoted expression, the member is
     * computed dynamically, and the member selection is done only at runtime. This
     * forces a statically unchecked member access.
     */
    ...
    public final void stringConstructorExpression() throws RecognitionException, TokenStreamException {
        ...
        if (inputState.guessing == 0) {
            ...
            currentAST.child = stringConstructorExpression_AST != null && stringConstructorExpression_AST.getFirstChild() != null ? stringConstructorExpression_AST.getFirstChild()
    ...
    /**
     * A list constructor is a argument list enclosed in square brackets, without
     * labels. Any argument can be decorated with a spread operator (*x), but not a
     * label (a:x). Examples: [], [1], [1,2], [1,*l1,2], [*l1,*l2]. (The l1, l2 must
     * be a sequence or null.)
     * <p>
     ...
     * spliced in. A colon alone between the brackets also forces the expression to
     * be an empty map constructor. Examples: [:], [a:1], [a:1,b:2], [a:1,*:m1,b:2],
     * [*:m1,*:m2] (The m1, m2 must be a map or null.) Values associated with
     * identical keys overwrite from left to right: [a:1,a:2] === [a:2]
     * <p>
     * Some malformed constructor expressions are not detected in the parser, but in
     * a post-pass. Bad examples: [1,b:2], [a:1,2], [:1]. (Note that method call
     * arguments, by contrast, can be a mix of keyworded and non-keyworded
     * arguments.)
     */
    public final void listOrMapConstructorExpression() throws RecognitionException, TokenStreamException {
        ...
        if ((LA(1) == LBRACK) && (_tokenSet_109.member(LA(2)))) {
            ...
            if (inputState.guessing == 0) {
                ...
                currentAST.child = listOrMapConstructorExpression_AST != null && listOrMapConstructorExpression_AST.getFirstChild() != null ? listOrMapConstructorExpression_AST.getFirstChild()
    ...
    /**
     * A single argument in (...) or [...]. Corresponds to to a method or closure
     * parameter. May be labeled. May be modified by the spread operator '*' ('*:'
     * for keywords).
     */
    public final byte argument() throws RecognitionException, TokenStreamException {
        ...
        if (inputState.guessing == 0) {
            ...
            require(LA(1) != COLON, "illegal colon after argument expression", "a complex label expression before a colon must be parenthesized");
    ...
    /**
     * For lookahead only. Fast approximate parse of an argumentLabel followed by a
     * colon.
     */
    ...
    public static final String[] _tokenNames = { "<0>", "EOF", "<2>", "NULL_TREE_LOOKAHEAD", "BLOCK", "MODIFIERS", "OBJBLOCK", "SLIST", "METHOD", "VARIABLE_DEF", "INSTANCE_INIT", "STATIC_INIT",
            "TYPE", "CLASS_DEF", "INTERFACE_DEF", "TRAIT_DEF", "PACKAGE_DEF", "ARRAY_DECLARATOR", "EXTENDS_CLAUSE", "IMPLEMENTS_CLAUSE", "PARAMETERS", "PARAMETER_DEF", "LABELED_STAT", "TYPECAST",
            "INDEX_OP", "POST_INC", "POST_DEC", "METHOD_CALL", "EXPR", "IMPORT", "UNARY_MINUS", "UNARY_PLUS", "CASE_GROUP", "ELIST", "FOR_INIT", "FOR_CONDITION", "FOR_ITERATOR", "EMPTY_STAT",
            "\"final\"", "\"abstract\"", "\"goto\"", "\"const\"", "\"do\"", "\"strictfp\"", "SUPER_CTOR_CALL", "CTOR_CALL", "CTOR_IDENT", "VARIABLE_PARAMETER_DEF", "STRING_CONSTRUCTOR",
            "STRING_CTOR_MIDDLE", "CLOSABLE_BLOCK", "IMPLICIT_PARAMETERS", "SELECT_SLOT", "DYNAMIC_MEMBER", "LABELED_ARG", "SPREAD_ARG", "SPREAD_MAP_ARG", "LIST_CONSTRUCTOR", "MAP_CONSTRUCTOR",
            "FOR_IN_ITERABLE", "STATIC_IMPORT", "ENUM_DEF", "ENUM_CONSTANT_DEF", "FOR_EACH_CLAUSE", "ANNOTATION_DEF", "ANNOTATIONS", "ANNOTATION", "ANNOTATION_MEMBER_VALUE_PAIR",
            "ANNOTATION_FIELD_DEF", "ANNOTATION_ARRAY_INIT", "TYPE_ARGUMENTS", "TYPE_ARGUMENT", "TYPE_PARAMETERS", "TYPE_PARAMETER", "WILDCARD_TYPE", "TYPE_UPPER_BOUNDS", "TYPE_LOWER_BOUNDS",
            "CLOSURE_LIST", "MULTICATCH", "MULTICATCH_TYPES", "a script header", "\"package\"", "\"import\"", "\"static\"", "\"def\"", "'['", "']'", "an identifier", "a string literal", "'<'", "'.'",
            "'('", "\"class\"", "\"interface\"", "\"enum\"", "\"trait\"", "'@'", "'?'", "\"extends\"", "\"super\"", "'>'", "','", "'>>'", "'>>>'", "\"void\"", "\"boolean\"", "\"byte\"", "\"char\"",
            "\"short\"", "\"int\"", "\"float\"", "\"long\"", "\"double\"", "'*'", "\"as\"", "\"private\"", "\"public\"", "\"protected\"", "\"transient\"", "\"native\"", "\"threadsafe\"",
            "\"synchronized\"", "\"volatile\"", "')'", "'='", "'&'", "'{'", "'}'", "';'", "\"default\"", "\"throws\"", "\"implements\"", "\"this\"", "'...'", "'|'", "'->'", "':'", "\"if\"",
            "\"else\"", "\"while\"", "\"switch\"", "\"for\"", "\"in\"", "\"return\"", "\"break\"", "\"continue\"", "\"throw\"", "\"assert\"", "'+'", "'-'", "\"case\"", "\"try\"", "\"finally\"",
            "\"catch\"", "'*.'", "'?.'", "'.&'", "\"false\"", "\"instanceof\"", "\"new\"", "\"null\"", "\"true\"", "'+='", "'-='", "'*='", "'/='", "'%='", "'>>='", "'>>>='", "'<<='", "'&='", "'^='",
            "'|='", "'**='", "'?:'", "'||'", "'&&'", "'^'", "'=~'", "'==~'", "'!='", "'=='", "'==='", "'!=='", "'<=>'", "'<='", "'>='", "'<<'", "'..'", "'..<'", "'++'", "'/'", "'%'", "'--'", "'**'",
            "'~'", "'!'", "STRING_CTOR_START", "a string literal end", "a numeric literal", "NUM_FLOAT", "NUM_LONG", "NUM_DOUBLE", "NUM_BIG_INT", "NUM_BIG_DECIMAL",
            "some newlines, whitespace or comments", "'$'", "whitespace", "a newline", "a single line comment", "a multi-line comment", "a string character", "a multiline regular expression literal",
            "a multiline dollar escaping regular expression literal", "a multiline regular expression literal end", "a multiline dollar escaping regular expression literal end", "ESCAPED_SLASH",
            "ESCAPED_DOLLAR", "a multiline regular expression character", "a multiline dollar escaping regular expression character", "an escape sequence", "a newline inside a string",
            "a hexadecimal digit", "a character", "a letter", "a digit", "a sequence of digits and underscores, bordered by digits",
            "a sequence of digits and underscores with maybe underscore starting", "an exponent", "a float or double suffix", "a big decimal suffix" };
