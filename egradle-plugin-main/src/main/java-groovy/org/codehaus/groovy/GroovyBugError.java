...
/**
 * This class represents an error that is thrown when a bug is recognized inside
 * the runtime. Basically it is thrown when a constraint is not fullfilled that
 * should be fullfiled.
 * 
...
public class GroovyBugError extends AssertionError {
	...
	/**
	 * Constructs a bug error using the given exception and a text with
	...
	/**
	 * Returns the detail message string of this error. The message will consist
	 * of the bug text prefixed by "BUG! " if there this instance was created
	 * using a message. If this error was constructed without using a bug text
	 * the message of the cause is used prefixed by "BUG! UNCAUGHT EXCEPTION: "
	 * 
