...
public class SelectConfigurationDialog extends Dialog {
    ...
    /**
     * Returns the initial location to use for the shell. The default implementation
     * centers the shell horizontally (1/2 of the difference to the left and 1/2 to
     * the right) and vertically (1/3 above and 2/3 below) relative to the parent
     * shell, or display bounds if there is no parent shell.
     *
