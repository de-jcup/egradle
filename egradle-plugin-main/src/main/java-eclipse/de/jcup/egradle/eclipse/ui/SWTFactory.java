...
public class SWTFactory {
     ...
     * 
     * @param button button for which to set the dimension hint
     */
    ...
    /**
     * Creates and returns a new push button with the given label, tooltip and/or
     * image.
     * 
     * @param parent  parent control
     * @param label   button label or <code>null</code>
    ...
    /**
     * Creates a new <code>CLabel</code> that will wrap at the specified width and
     * has the specified image
     * 
     ...
     *                     parent
     * @param fill         the style for how this composite should fill into its
     *                     parent
     * @param marginwidth  the width of the margin to place on the sides of the
     *                     composite (default is 5, specified by GridLayout)
     * @param marginheight the height of the margin to place o the top and bottom of
     *                     the composite
     ...
     * @param parent       the parent composite to add this composite to
     * @param font         the font to set on the control
     * @param style        the style bits for the composite. See {@link Composite}
     *                     for details on supported style bits
     * @param columns      the number of columns within the composite
     * @param hspan        the horizontal span the composite should take up on the
     *                     parent
     * @param fill         the style for how this composite should fill into its
