...
public enum EGradleCallType {
    /* Linux/Mac etc. */
    LINUX_GRADLE_WRAPPER("linux.gradlewrapper", "./gradlew"), LINUX_GRADLE_INSTALLED("linux.installed", "gradle"),
    /* Windows */
    WINDOWS_GRADLE_WRAPPER("windows.gradlewrapper", "gradlew.bat", EGradleShellType.CMD, ""), WINDOWS_GRADLE_INSTALLED("windows.installed", "gradle.bat"),
    /* Custom */
    CUSTOM("custom", "");
