...
public class ReplaceJavaDocPartsActionTest {
    ...
    public void parameter_conversion3() throws IOException {
        ...
        list.add("     * <p>Called when the projects for the build have been created from the settings. None of the projects have been");
    ...
    public void link_3() {
        ...
        String expected = "More examples in docs for " + "<a href='type://EclipseProject'>EclipseProject</a>, " + "<a href='type://EclipseClasspath'>EclipseClasspath</a>, "
    ...
    public void link_4_mixed_arguments() {
        ...
        String expected = "More examples in docs for " + "<a href='type://EclipseProject'>EclipseProject</a>, " + "{@xxx EclipseClasspath}, " + "<a href='type://EclipseWtp'>EclipseWtp</a> ";
        assertEquals(expected, actionToTest.replaceJavaDocParts(line));
    }
