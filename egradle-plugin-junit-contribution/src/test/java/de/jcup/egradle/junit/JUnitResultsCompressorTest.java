...
public class JUnitResultsCompressorTest {
	...
	@Test
	public void two_testsuites_with_one_and_two_failures_result_in_testsuites_rootelement_with_3_failures()
			throws Exception {
		/* prepare */
	...
	@Test
	public void two_testsuites_with_one_and_three_errors_result_in_testsuites_rootelement_with_4_errors()
			throws Exception {
		/* prepare */
		Collection<InputStream> streams = new ArrayList<>();
	...
	@Test
	public void two_testsuites_with_two_and_three_tests_result_in_testsuites_rootelement_with_5_tests()
			throws Exception {
		/* prepare */
		Collection<InputStream> streams = new ArrayList<>();
	...
	@Test
	public void two_testsuites_with_six_seconds_and_three_point2_seconds_result_in_testsuites_rootelement_with_9point2_seconds()
			throws Exception {
		/* prepare */
		Collection<InputStream> streams = new ArrayList<>();
	...
	@Test
	public void two_testsuites_with_two_testcases_inside_are_in_result_document_as_well__without_pseudo_testsuite()
			throws Exception {
		/* prepare */
		Collection<InputStream> streams = new ArrayList<>();
	...
	@Test
	public void two_testsuites_with_two_testcases_inside_are_in_result_document_as_well_with_gradle_pseudo_testsuite()
			throws Exception {
		/* prepare */
		Collection<InputStream> streams = new ArrayList<>();
		String text1 = "<testsuite name='suite1'><testcase name='name1'/></testsuite>";
