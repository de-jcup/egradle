...
public class NewProjectContextTest {
	...
	@Test
	public void invalid_when_java_support_enabled_and_java_version_set__AND_JAVA_HOME_set_to_an_existing_file()
			throws IOException {
		/* prepare */
	...
	public void to_properties_contains_java_version_set_in_context() {
		...
		assertEquals("JavaVersion.VERSION_1_8",
				properties.get(NewProjectTemplateVariables.VAR__JAVA__VERSION.getVariableName()));
	}
	...
	public void to_properties_contains_gradle_version_set_in_context__check_default_when_nothing() {
		...
		Properties properties = contextToTest.toProperties();
		assertNotNull(properties);
		assertEquals(NewProjectTemplateVariables.VAR__GRADLE__VERSION.getDefaultValue(),
				properties.get(NewProjectTemplateVariables.VAR__GRADLE__VERSION.getVariableName()));
	}
	...
	public void to_properties_contains_multi_projects_set_in_context() {
		...
		assertNotNull(properties);
		assertEquals("'core',\n'server',\n'ui'",
				properties.get(NewProjectTemplateVariables.VAR__MULTIPROJECTS__INCLUDE_SUBPROJECTS.getVariableName()));
	}
