...
public class EGradleProjectDecorator extends LabelProvider implements ILightweightLabelDecorator {
    ...
    private static ImageDescriptor egradleProjectDescriptor = new LazyImageDescriptor(EclipseUtil.createImageDescriptor("icons/gradle-project-decorator.gif", IDEActivator.PLUGIN_ID));
    ...
    public void decorate(Object element, IDecoration decoration) {
        ...
        if (hasVirtualRootProjectNature(p)) {
            ...
            /*
             * Because the virtual root project is not hosted in SCM - at least with GIT,
             * there is always an ugly question icon at IDecoration.BOTTOM_RIGHT . To avoid
             * this we simply render an empty deocorator here. This is okay, because diff
    ...
    /**
     * An image descriptor which only creates the image data once - no matter what
     * the origin image descriptor does
     */
