...
public interface EGradleLauncherConstants {
    ...
    /**
     * The path to the gradle root project. If set not the default root path from
     * preferences shall be used but this one... So launch configurations can
     * created not only for current root project.
     */
